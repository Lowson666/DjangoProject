...
from user_page.views import islogin
from cart_page.models import CartInfo
from goods_page.models import GoodsInfo
from user_page.models import UserInfo
...
def order(request):
    ...
    return render(request, 'order_page/place_order.html', context)
...
def pay(request,oid):
    ...
    print (order.oid)
    context = {'oid': oid}
    return render(request, 'order_page/pay.html', context)