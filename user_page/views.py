...
from goods_page.models import GoodsInfo
from order_page.models import OrderInfo
from django.core.paginator import Paginator
from cart_page.models import *
...
def info(request):
    ...
    return render(request, 'user_page/user_center_info.html', context)

# 订单
@islogin
def order(request):
    context = {'title': '用户中心','page_name':1,'order':1}
    return render(request, 'user_page/user_center_order.html', context)
...
def site(request):
    ...
    return render(request, 'user_page/user_center_site.html', context)
